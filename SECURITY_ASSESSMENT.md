...
- New synthetic case | الحالة الاصطناعية الجديدة: `{"asset": "Order data", "case_id": "L-SEC-001", "control": "Owner check before disclosure", "expected_flag": "cross_customer_access", "payload_length": 59}`
...
- Assessment run ID | معرّف التقييم: `run-564c552e9c25470e`
