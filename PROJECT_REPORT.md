...
- Assessment run ID | معرّف تشغيل التقييم: `run-564c552e9c25470e`
- Generated UTC | وقت الإنشاء: 2026-09-22T07:14:26.276072+00:00
...
- Median latency | وسيط الزمن: 2.316 ms
...
- New threat case metadata | بيانات الحالة الجديدة: `{"asset": "Order data", "case_id": "L-SEC-001", "control": "Owner check before disclosure", "expected_flag": "cross_customer_access", "payload_length": 59}`
...
- Before | قبل: 3.752 ms / 500 iterations
- After | بعد: 0.399 ms / 500 iterations
- Cache hits / misses | إصابات / إخفاقات التخزين: 499 / 1
- Learner trade-off and guardrail | مقايضة وضابط المتدرب: Measured trade-off: caching reduced policy lookup latency from 3.752 ms to 0.399 ms over 500 iterations. Guardrail: cache keys contain only locale, category, and active policy version; customer data must never be included in the cache key.
